<script>
    ...
    const imgAlt = "A photograph taken of me in 2020, behind a sunny though obscured, Chicago skyline";
...
<div class="hero">
    {#if mounted}
        ...
        <div class="pic">
            <img transition:fade={{delay: 300, duration}} alt={imgAlt} src="DSC04172.webp">
...
<style lang="scss">
  ...
  .menu-bar {
    ...
    a {
      ...
      position: relative;
      box-shadow: -6px 4px 0px var(--mint);
      height: 2.5em;
      letter-spacing: 1em;
      font-size: 17px;
      color: white;
